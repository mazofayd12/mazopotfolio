            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
              {displayProjects.map((project) => (
                ...
                >
                  ...
                  <div className="relative aspect-video w-full overflow-hidden flex items-center justify-center p-6 bg-gradient-to-br from-indigo-950 to-background border-b border-white/[0.04]">
                    <span className="font-heading text-lg md:text-xl font-bold tracking-wider text-white/30 group-hover:scale-110 transition-transform duration-500">
